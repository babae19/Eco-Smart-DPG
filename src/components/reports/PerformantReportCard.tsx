...
interface PerformantReportCardProps {
  report: Report;
...
const PerformantReportCard: React.FC<PerformantReportCardProps> = React.memo(({
  report,
  onUpvote,
  onLike,
  onOpenComments,
  ...
  // Event handlers (memoized to prevent recreating on each render)
  const handleUpvote = React.useCallback((e: React.MouseEvent) => {
    e.stopPropagation();
    onUpvote(report.id);
  }, [onUpvote, report.id]);
  ...
  const handleComments = React.useCallback((e: React.MouseEvent) => {
    e.stopPropagation();
    onOpenComments();
  }, [onOpenComments]);
...
PerformantReportCard.displayName = 'PerformantReportCard';

export default PerformantReportCard;